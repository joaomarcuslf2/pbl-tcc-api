...
ActiveRecord::Schema.define(version: 2019_11_29_131159) do
  ...
  create_table "pills", force: :cascade do |t|
    ...
    t.index ["requisite_id"], name: "index_pills_on_requisite_id"
  end
  ...
  create_table "recommendations", force: :cascade do |t|
    ...
    t.index ["requisite_id"], name: "index_recommendations_on_requisite_id"
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.index ["requisite_id"], name: "index_reviews_on_requisite_id"
